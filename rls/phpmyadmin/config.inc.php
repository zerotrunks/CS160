...
//$cfg['Servers'][$i]['host']          = 'mh213b'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['user']          = 'cssjsuor_160s1g2';      // MySQL user
$cfg['Servers'][$i]['password']      = 'theateam';          // MySQL password (only needed
